...
elTemplateBox.addEventListener('input', (e)=> { // click listener change the main template
...
elConjBox.addEventListener('input', (e)=> { // click listener to change the main template
    if(elConjBox.value) {
...
elConjCheck.addEventListener('change', (e)=> { // toggles conjunctions visibility
...
elType.addEventListener('input', (e)=> { // click listener to populate the word box
...
elWord.addEventListener('input', (e)=> { // click listener to select a word and refresh the template    
    if(elWord.value) {                
        firstWord = elWord.value;        
        currentIndexes.word1 = parseInt(e.target.querySelector("option:checked").id);
...
elTemplateBox2.addEventListener('input', (e)=> { // click listener to change the main template
...
elType2.addEventListener('input', (e)=> { // click listener to populate the word box
...
elWord2.addEventListener('input', (e)=> { // click listener to select a word and refresh the template
    if(elWord2.value) {
        secondWord = elWord2.value;
        currentIndexes.word2 = parseInt(e.target.querySelector("option:checked").id);
...
/** ------------------------- coiled sword ------------------------- */
$('#returnHomepage').addEventListener('pointerdown', (e)=> {
        ...
        xhr.onreadystatechange = ()=> {
          if (xhr.readyState === 4) {            
              ...
              if(response.pathExists){
                  ...
                  return $('#modalRedirectButton').addEventListener('pointerdown', (e)=> {
